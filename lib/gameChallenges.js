...
import { getCalendarDateYMDForTimeZone, getGameCalendarDateYMD } from "./calendarDate";
...
export function getTodayIsoDate(timeZone = "") {
  if (!timeZone) return getGameCalendarDateYMD();
  return getCalendarDateYMDForTimeZone(timeZone);
}
